...
import com.example.praktikum14.navigasi.DestinasiDetail
import com.example.praktikum14.ui.viewmodel.DetailUiState
import com.example.praktikum14.ui.viewmodel.DetailViewModel
    ...
    when {
        ...
        detailUiState.nama.isEmpty() -> Column(
            ...
            Column(
                ...
                Text(text = "Judul Skripsi: ${detailUi.judulSkripsi}", style = MaterialTheme.typography.bodyLarge)
                Text(text = "Dosbim 1: ${detailUi.dosbim1}", style = MaterialTheme.typography.bodyLarge)
                Text(text = "Dosbim 2: ${detailUi.dosbim2}", style = MaterialTheme.typography.bodyLarge)
            }
        }
    }
}